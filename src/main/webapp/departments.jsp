        ...
        <div id="content">
            ...
            <table class="table">
                ...
                <tr class="row1">
                    ...
                    <td>
                        <a href=${pageContext.request.contextPath}/department/queryID?id=${department.id}>更新</a>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/employee/show?employeedepartmentid=${department.id}">员工列表</a>
                    </td>
                </tr>
                </c:forEach>
            </table>
