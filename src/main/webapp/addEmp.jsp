            ...
            <form action="${pageContext.request.contextPath}/employee/add" method="post">
                <table cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        ...
                        <td valign="middle" align="left">
                            <input type="text" class="inputgri" name="employee.employeename" />
                        </td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right">
                        ...
                        <td valign="middle" align="left">
                            <input type="text" class="inputgri" name="employee.employeesalary" />
                        </td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right">
                        ...
                        <td valign="middle" align="left">
                            <input type="text" class="inputgri" name="employee.employeeage" />
                        </td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right">
